...
* with module pattern organization
* 
*/
...
crypto.sha = (function() {
	...
	var str_sha1_b = function(s){return (core_sha1(str2binb(s),s.length * chrsz));}
	var hex_hmac_sha1 = function(key, data){ return binb2hex(core_hmac_sha1(key, data));}
	var b64_hmac_sha1 = function(key, data){ return binb2b64(core_hmac_sha1(key, data));}
	var str_hmac_sha1 = function(key, data){ return binb2str(core_hmac_sha1(key, data));}
	...
	return {
		/*aws: function (data,secret) {
			return hmacSHA1(data, secret);
		}*/
    str_sha1_b: str_sha1_b
    };
